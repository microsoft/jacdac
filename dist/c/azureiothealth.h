// Autogenerated C header file for Azure IoT Health
#ifndef _JACDAC_SPEC_AZURE_IO_THEALTH_H
#define _JACDAC_SPEC_AZURE_IO_THEALTH_H 1

#define JD_SERVICE_CLASS_AZURE_IO_THEALTH  0x1462eefc

// enum ConnectionStatus (uint16_t)
#define JD_AZURE_IO_THEALTH_CONNECTION_STATUS_CONNECTED 0x0
#define JD_AZURE_IO_THEALTH_CONNECTION_STATUS_DISCONNECTED 0x1
#define JD_AZURE_IO_THEALTH_CONNECTION_STATUS_CONNECTING 0x2
#define JD_AZURE_IO_THEALTH_CONNECTION_STATUS_DISCONNECTING 0x3

/**
 * Read-only string (bytes). Name of the connected hub, if any.
 */
#define JD_AZURE_IO_THEALTH_REG_HUB 0x180
 ...
 */
#define JD_AZURE_IO_THEALTH_REG_CONNECTION_STATUS 0x181

/**
 * Reads internal statistics about messages sent to the hub.
 */
#define JD_AZURE_IO_THEALTH_REG_STATISTICS 0x182
typedef struct jd_azure_io_thealth_statistics {
    uint32_t reading;
    uint32_t event;
    uint32_t twin_reported;
    uint32_t twin_desired;
} jd_azure_io_thealth_statistics_t;


/**
 * Argument: twin_report pipe (bytes). Returns the twin json payload
 */
#define JD_AZURE_IO_THEALTH_CMD_TWIN 0x80
 ...
 */
#define JD_AZURE_IO_THEALTH_EV_TWIN_CHANGE JD_EV_CHANGE

/**
 * Argument: connection_status ConnectionStatus (uint16_t). Raised when the connection status changes
 */
#define JD_AZURE_IO_THEALTH_EV_CONNECTION_STATUS_CHANGE 0x80
