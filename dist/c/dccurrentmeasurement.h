...
#ifndef _JACDAC_SPEC_D_CCURRENT_MEASUREMENT_H
#define _JACDAC_SPEC_D_CCURRENT_MEASUREMENT_H 1

#define JD_SERVICE_CLASS_D_CCURRENT_MEASUREMENT  0x1912c8ae
 ...
 */
#define JD_D_CCURRENT_MEASUREMENT_REG_MEASUREMENT_NAME 0x182

/**
 * Read-only A f64 (uint64_t). The current measurement.
 */
#define JD_D_CCURRENT_MEASUREMENT_REG_MEASUREMENT JD_REG_READING
