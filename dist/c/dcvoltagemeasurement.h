...
#ifndef _JACDAC_SPEC_D_CVOLTAGE_MEASUREMENT_H
#define _JACDAC_SPEC_D_CVOLTAGE_MEASUREMENT_H 1

#define JD_SERVICE_CLASS_D_CVOLTAGE_MEASUREMENT  0x1633ac19

// enum VoltageMeasurementType (uint8_t)
#define JD_D_CVOLTAGE_MEASUREMENT_VOLTAGE_MEASUREMENT_TYPE_ABSOLUTE 0x0
#define JD_D_CVOLTAGE_MEASUREMENT_VOLTAGE_MEASUREMENT_TYPE_DIFFERENTIAL 0x1
 ...
 */
#define JD_D_CVOLTAGE_MEASUREMENT_REG_MEASUREMENT_TYPE 0x181
 ...
 */
#define JD_D_CVOLTAGE_MEASUREMENT_REG_MEASUREMENT_NAME 0x182

/**
 * Read-only V f64 (uint64_t). The voltage measurement.
 */
#define JD_D_CVOLTAGE_MEASUREMENT_REG_MEASUREMENT JD_REG_READING
