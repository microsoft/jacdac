// Autogenerated C header file for Mono Light
#ifndef _JACDAC_SPEC_MONO_LIGHT_H
#define _JACDAC_SPEC_MONO_LIGHT_H 1

#define JD_SERVICE_CLASS_MONO_LIGHT  0x1fb57453
 ...
 */
#define JD_MONO_LIGHT_REG_STEPS 0x82
typedef struct jd_mono_light_steps {
    uint16_t start_intensity; // ratio
    uint16_t duration; // ms
} jd_mono_light_steps_t;
 ...
 */
#define JD_MONO_LIGHT_REG_CURRENT_ITERATION 0x80

/**
 * Read-write uint16_t. The animation will be repeated `max_iterations + 1` times.
 */
#define JD_MONO_LIGHT_REG_MAX_ITERATIONS 0x81
