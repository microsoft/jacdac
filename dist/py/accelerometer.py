# Autogenerated file for Accelerometer
...
_JD_ACCELEROMETER_REG_MAX_FORCE = const(JD_REG_READING_RANGE)
_JD_ACCELEROMETER_REG_MAX_FORCES_SUPPORTED = const(JD_REG_SUPPORTED_RANGES)
