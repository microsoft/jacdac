...
JD_HEART_RATE_VARIANT_FINGER = const(0x1)
JD_HEART_RATE_VARIANT_CHEST = const(0x2)
JD_HEART_RATE_VARIANT_WRIST = const(0x3)
JD_HEART_RATE_VARIANT_PUMP = const(0x4)
JD_HEART_RATE_VARIANT_WEB_CAM = const(0x5)
