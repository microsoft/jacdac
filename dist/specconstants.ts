...
export const SRV_AZURE_IO_THEALTH = 0x1462eefc

export enum AzureIoTHealthConnectionStatus { // uint16_t
    Connected = 0x0,
    Disconnected = 0x1,
    Connecting = 0x2,
    Disconnecting = 0x3,
...
export enum AzureIoTHealthEvent {
    /**
