...
Any manufacturer of JACDAC device is encourage to add their devices 
...
* ``FIRMWARE_ID`` is the unique firmware identifer for the device. The JACDAC tool will detect duplicates.
...
* White background, top picture

## Firmware updates

Firmware updates can be hosted as **assets** on **releases** of GitHub repositories. Upon detecting a device with the firmware identifier, 
