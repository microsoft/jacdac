...
The transport layer ensures data packets are sent to the correct services and applications. Supporting the transport layer are also mechanisms to ensure packets are sent reliably to their destinations.
