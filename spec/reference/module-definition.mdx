...
The JACDAC project maintains a catalog of known [modules](/modules)
in the https://github.com/microsoft/jacdac repository. 
Any manufacturer of JACDAC device is encouraged to add their own *modules
* to the catalog following the instructions below.

## Catalog format

The module catalog is stored as markdown text files and JPEG images, organized under the [JACDAC devices](https://github.com/microsoft/jacdac/tree/main/devices) folder.
