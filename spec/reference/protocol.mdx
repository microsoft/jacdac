...
A Jacdac device is any device that generates its own unique [device identifier](#deviceIdentity) 
and implements the Jacdac protocol.  The protocol consists of three core layers, described below,
with link to more detail.

### Service Layer: how Jacdac devices share hardware or software resources with one another
...
* [Read more about the service layer](#serviceLayer)
...
* [Read more about the transport layer.](#transportLayer)
...
* [Read more about the physical layer.](#physicalLayer)


<a name="deviceIdentity"></a> 
## Device Identity
