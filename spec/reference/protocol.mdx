...
For more information, see [the single wire serial protocol](/reference/protocol/single-wire-serial/).
...
- [Single Wire Serial](/reference/protocol/single-wire-serial/) connects microcontrollers to each other using UART
