...
Jacdac (Joint Asynchronous Communication; Device Agnostic Control) is a new protocol designed 
...
1. The [service layer](./protocol/service-layer)––How Jacdac devices share hardware 
or software resources with one another.
2. The [transport layer](./protocol/transport-layer)––Responsible for reliably routing packets 
to and from services and applications.
3. The [physical layer](./protocol/physical-layer)––Transmits and receives packets from other 
Jacdac devices.
...
* [Read more about the service layer](./protocol/service-layer)
