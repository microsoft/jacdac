...
Services are registered in the [service catalog](/services) and described by [service specifications](/reference/specificatin/service-specification).
...
[Read more about the physical layer.](./protocol/physical-layer)
