...
1. The [service layer](./service-layer)––How Jacdac devices share hardware 
or software resources with one another.
2. The [transport layer](./transport-layer)––Responsible for reliably routing packets 
to and from services and applications.
3. The [physical layer](./physical-layer)––Transmits and receives packets from other 
Jacdac devices.
