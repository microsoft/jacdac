...
|--------------:| ------------------------------------
| `0x00`        | Reserved
| `0x01`        | Command (action, register) not supported
| `0x02`        | Invalid command arguments (will never succeed)
| `0x03`        | Invalid state (can succeed in future)
| `0x04`        | Hardware failure (possibly transient)
