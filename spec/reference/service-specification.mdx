...
The value of the register may have one of the unit or secondary defined in [SenML](https://tools.ietf.org/html/rfc8428),
in addition to ``""`` (identifiers), ``"us"`` micro seconds, ``"mWh"`` milli watt-hours and ``"#"`` counts.
