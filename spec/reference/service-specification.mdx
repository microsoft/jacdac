...
Service mixins, services with class identifier starting with `0x2...`, allow to enhance existing services with new registers, typically vendor specific registers to configure
the hardware device.