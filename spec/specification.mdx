...
service, which is always `0x00000000`.
...
* [Glossary](/spec/specification/glossary)
* [Device Catalog Specification](/spec/specifiation/device-catalog)
* [Service Specification Language](/spec/specification/service-spec-language)